...
var board_default = import_runtime.default.template({ "0": function(container, depth0, helpers, partials, data, blockParams, depths) {
  ...
  return '                <station class="location stop can-scroll' + ((stack1 = lookupProperty(helpers, "if").call(alias1, data && lookupProperty(data, "last"), { "name": "if", "hash": {}, "fn": container.program(3, data, 0), "inverse": container.noop, "data": data, "loc": { "start": { "line": 28, "column": 56 }, "end": { "line": 28, "column": 82 } } })) != null ? stack1 : "") + '" role="listitem"' + ((stack1 = lookupProperty(helpers, "if").call(alias1, data && lookupProperty(data, "last"), { "name": "if", "hash": {}, "fn": container.program(4, data, 0), "inverse": container.noop, "data": data, "loc": { "start": { "line": 28, "column": 99 }, "end": { "line": 28, "column": 145 } } })) != null ? stack1 : "") + ">\r\n                    " + alias3((lookupProperty(helpers, "fallback") || depth0 && lookupProperty(depth0, "fallback") || alias2).call(alias1, depth0 != null ? lookupProperty(depth0, "locationName") : depth0, "Unknown", { "name": "fallback", "hash": {}, "data": data, "loc": { "start": { "line": 29, "column": 20 }, "end": { "line": 29, "column": 55 } } })) + '\r\n                    <time class="estimated"' + ((stack1 = lookupProperty(helpers, "if").call(alias1, data && lookupProperty(data, "last"), { "name": "if", "hash": {}, "fn": container.program(5, data, 0), "inverse": container.noop, "data": data, "loc": { "start": { "line": 30, "column": 43 }, "end": { "line": 30, "column": 86 } } })) != null ? stack1 : "") + ' datetime="' + alias3((lookupProperty(helpers, "callingPointDateTime") || depth0 && lookupProperty(depth0, "callingPointDateTime") || alias2).call(alias1, depth0, (stack1 = (stack1 = data && lookupProperty(data, "root")) && lookupProperty(stack1, "board")) && lookupProperty(stack1, "generatedAt"), { "name": "callingPointDateTime", "hash": {}, "data": data, "loc": { "start": { "line": 30, "column": 97 }, "end": { "line": 30, "column": 150 } } })) + '">' + alias3((lookupProperty(helpers, "displayTime") || depth0 && lookupProperty(depth0, "displayTime") || alias2).call(alias1, depth0, { "name": "displayTime", "hash": {}, "data": data, "loc": { "start": { "line": 30, "column": 152 }, "end": { "line": 30, "column": 172 } } })) + "</time>\r\n                </station>\r\n";
...
function resolvePreferredDataSource(config, previousConfig) {
...
function shouldPreserveExistingDataSource(previousConfig, config) {
...
`;
var DEFAULT_FONT_PATH = new URL(".", import.meta.url).toString().replace(/\/$/, "");
...
var UkrailboardsCard = class extends HTMLElement {
  ...
  setConfig(config) {
    ...
    const resolvedDataSource = preserveExistingDataSource ? previousConfig.data_source : resolvePreferredDataSource(config, previousConfig);
    this._config = {
